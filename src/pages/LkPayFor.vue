      ...
      <div class="wrapper">
        <div class="top-bar">
          ...
          <div class="select">
            <div class="flex align-items-center">
              ...
              <div class="flex-column select__wallet-info">
        ...
        <div class="payment-block">
          ...
          <div class="payment-directions">
            <div class="payment-direction" v-for="paymentDirection in paymentDirections" @click="handleChangePaymentsDirection(paymentDirection.text)" :class="{ active: activePaymentDirection === paymentDirection.text }">
              <div class="payment-direction__chosen-block" v-show="activePaymentDirection === paymentDirection.text">
